...
## Example Playbook
    ...
    - hosts: webservers
      vars_files:
        - vars/main.yml
      roles:
        - { role: msherron.php-debian-lucid }
...
This role is a fork of a role that was created in 2014 by [Jeff Geerling](http://jeffgeerling.com/), author of [Ansible for DevOps](http://ansiblefordevops.com/).
